        ...
        public static IEnumerable<object[]> Specific
        {
            get
            {
                return new[] {
                    ...
                    new[] {"group_committees_a_to_z_current" },
                    new[] {"group_committees_a_to_z" },
                    new[] {"group_committees_by_initial?initial=p" },
                    new[] {"group_committees_current_by_initial?initial=a" },
                    new[] {"group_committees_current" },
                    new[] {"group_current" },
                    new[] {"group_government_organisation_a_to_z" },
                    new[] {"group_government_organisation_by_initial?initial=d" },
                    new[] {"group_government_organisation_current_a_to_z" },
                    new[] {"group_government_organisation_current_by_initial?initial=d" },
                    new[] {"group_government_organisation_current" },
                    new[] {"group_government_organisation_index" },

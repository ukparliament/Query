namespace Parliament.Data.Api.FixedQuery.Controllers
{
    ...
    public partial class FixedQueryController
    {
        ...
        [HttpGet]
        public HttpResponseMessage person_by_id_mock(string person_id)
        {
...
<http://id.ukpds.org/tJxPOiSd> <http://id.ukpds.org/schema/memberHasFormalBodyMembership> <http://id.ukpds.org/JCORBTRADECOMMITTEEMEMBERSHIP> .
...
<http://id.ukpds.org/tJxPOiSd> <http://id.ukpds.org/schema/memberHasFormalBodyMembership> <http://id.ukpds.org/JCORBJOBSCOMMITTEEMEMBERSHIP> .
...
<http://id.ukpds.org/JCORBJOBSCOMMITTEEMEMBERSHIP> <http://id.ukpds.org/schema/formalBodyMembershipEndDate> '20012-06-08'^^<http://www.w3.org/2001/XMLSchema#date> .
...
");
            response.Content.Headers.ContentType = new MediaTypeHeaderValue("application/n-triples");
            return response;
        }
        ...
        [HttpGet]
        public HttpResponseMessage committee_by_id(string committee_id)
        {
            var response = Request.CreateResponse();
            response.Content = new StringContent(@"
<http://id.ukpds.org/TRADECOMMITTEE> <http://id.ukpds.org/schema/formalBodyName> 'Trade Committee' .
...
<http://id.ukpds.org/JCORBTRADECOMMITTEEMEMBERSHIP> <http://id.ukpds.org/schema/formalBodyMembershipStartDate> '1991-06-08'^^<http://www.w3.org/2001/XMLSchema#date> .
<http://id.ukpds.org/JCORBTRADECOMMITTEEMEMBERSHIP> <http://id.ukpds.org/schema/formalBodyMembershipEndDate> '2001-06-08'^^<http://www.w3.org/2001/XMLSchema#date> .
<http://id.ukpds.org/JCORBTRADECOMMITTEEMEMBERSHIP> <http://id.ukpds.org/schema/formalBodyMembershipHasMember> <http://id.ukpds.org/tJxPOiSd> .
...
<http://id.ukpds.org/BBORBTRADECOMMITTEEMEMBERSHIP> <http://id.ukpds.org/schema/formalBodyMembershipHasMember> <http://id.ukpds.org/BEREMY> .
...
");
        ...
        [HttpGet]
        public HttpResponseMessage committee_index()
        {
            var response = Request.CreateResponse();
            response.Content = new StringContent(@"
<http://id.ukpds.org/TRADECOMMITTEE> <http://id.ukpds.org/schema/formalBodyName> 'Trade Committee' .
